...
User1 = User(name="Robo Barista", email="tinnyTim@udacity.com",
             picture="""https://pbs.twimg.com/profile_images/2
             671170543/18debd694829ed78203a5a36dd364160_400x400.png""")
session.add(User1)
session.commit()
...
menuItem7 = MenuItem(user_id=1, name="Grilled Cheese Sandwich",
                     description="On texas toast with American Cheese", price="$3.49",
...
menuItem2 = MenuItem(user_id=1, name="Peking Duck",
                     ...
                     has been prepared since the imperial era. The meat is prized 
                     for its thin, crisp skin, with authentic versions of the 
                     dish serving mostly the skin and little meat, sliced in 
                     front of the diners by the cook""", price="$25", course="Entree", 
...
menuItem2 = MenuItem(user_id=1, name="Chinese Dumplings", 
                    ...
                    which generally consists of minced meat 
                    and finely chopped vegetables wrapped into
                     a piece of dough skin. The skin can be 
...
menuItem3 = MenuItem(user_id=1, name="Gyoza", 
                    ...
                    gyoza with salt and soy sauce, and in a thin 
                    gyoza wrapper""",
...
menuItem1 = MenuItem(user_id=1, name="Boysenberry Sorbet", 
                    ...
                    ripe berries turned into frozen (and seedless) awesomeness""",
                     price="$2.99", course="Dessert", restaurant=restaurant1)
...
menuItem4 = MenuItem(user_id=1, name="Tandoori Chicken", 
                    description="""Chicken marinated in yoghurt and s
                    easoned with a spicy mix(chilli, tamarind among others) 
                    and slow cooked in a cylindrical clay or metal oven which
